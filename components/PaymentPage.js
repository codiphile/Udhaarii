...
const PaymentPage = ({ username }) => {
  ...
  return (
    <>
      ...
      <div className="info flex justify-center items-center mt-24 flex-col gap-2">
        ...
        <div className="payment flex gap-12 w-[80%] mt-8 mb-4 flex-col md:flex-row">
          <div className="supporters  md:w-1/2 bg-slate-900 rounded-lg text-white px-2 md:p-10">
          ...
          <div className="makePayment h-full w-full md:w-1/2 bg-slate-900 rounded-lg  text-white px-2  md:p-10 ">

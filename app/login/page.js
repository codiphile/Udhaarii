...
function Login() {
  ...
  return (
    <div className="text-white py-14 container mx-auto max-h-[50vh]">
      <h1 className="text-center font-bold text-3xl">Login to Get Started</h1>

      <div className="flex flex-col lg:gap-2  items-center  p-10 gap-10  mb-0">
